...
void Image::clear() {
  // beware, for clear to behave properly, with width and height must be zero if there 
  // is nothing on the heap, or the original values of width and height if there is 
  // memory on the heap
